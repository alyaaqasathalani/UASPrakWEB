  <div class="col-md-4">
          ...
          <!-- Search Widget -->
          <div class="card mb-4">
            <h5 class="card-header">Cari Resep Sesuai Bahanmmu!</h5>
            <div class="card-body">
                   <form name="search" action="search.php" method="post">
              <div class="input-group">
           
        <input type="text" name="searchtitle" class="form-control" placeholder="Cari Dengan" required>
...
<?php } ?>
          ...
          <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header">Resep Terbaru</h5>
            <div class="card-body">
                      <ul class="mb-0">
<?php
